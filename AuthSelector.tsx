...
export const AuthSelector: React.FC = () => {
  ...
  // Cada etapa tem uma largura de conteúdo diferente: a tela de escolha
  // inicial (2 cards lado a lado) e as telas de planos precisam de bem mais
  // espaço horizontal do que o formulário de código de convite. Antes, só
  // 'personal-plans'/'institution-plans' contavam como "largas" e 'choice'
  // ficava preso em max-w-md (448px), espremendo os dois cards.
  const stepMaxWidthClass =
    step === 'choice'
      ? 'max-w-5xl'
      : step === 'personal-plans' || step === 'institution-plans'
      ? 'max-w-7xl'
      : 'max-w-md';

  return (
    <div className="min-h-screen flex items-center justify-center bg-muted/30 p-4">
      <div className={cn('w-full transition-all duration-500', stepMaxWidthClass)}>
